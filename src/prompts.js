...
3. ゲート数は8〜12本。最低1本、その時点で既に振幅が届いている成分をtargetとする合流ゲートを必ず含める。合流がゼロの回路では干渉診断が無効になる。
...
### いまの生々しさ
これは時間の中身ではなく、時間相同士がモデル上でどれだけ切り離されずに保持されているかです。現在の人口が大きいことと、臨在コヒーレンスが高いことは別の発見です。両方を一文にまとめないでください。
