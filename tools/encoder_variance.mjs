...
const bindingValues = measurements.map((result) => result.entanglement12.binding_normalized);
...
const summary = {
  ...
  binding_normalized: {
    mean: bindingValues.length ? mean(bindingValues) : null,
    std: sampleStd(bindingValues),
